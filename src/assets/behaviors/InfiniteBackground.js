...
class InfiniteBackground extends GameBehavior {
    ...
    update() {
        ...
        this.activeScroller.transform.position = Vector3.add(this.activeScroller.transform.position, Vector3.scale(this.scrollVelocity, Time.deltaTime));
        ...
        if(this.previousScroller) {
            this.previousScroller.transform.position = Vector3.add(this.previousScroller.transform.position, Vector3.scale(this.scrollVelocity, Time.deltaTime));
        }
        ...
        if(currentRightBound < this.rightBound) {
            ...
            this.activeScroller = new this.backgroundToSpawn();
            this.activeScroller.transform.position = Vector3.add(this.startPos, new Vector3(this.rightBound - .5, 0, 0));
            SceneManager.activeScene.instantiate(this.activeScroller);
        }
    }
}

module.exports = InfiniteBackground;